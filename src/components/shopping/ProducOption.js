    ...
    return (
        <div className={classes.root}>
            <FormControl className={classes.size}>
                <InputLabel className={classes.label} htmlFor="age-native-simple">Size</InputLabel>
                <Select
                    native
                    value={state.age}
            ...
            <FormControl className={classes.quantity}>
                <InputLabel className={classes.label}  htmlFor="age-native-simple">Quantity</InputLabel>
                <Select
                    native
                    value={state.age}
